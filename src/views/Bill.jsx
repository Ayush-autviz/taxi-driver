    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            {on_load == 1 &&
                <ScrollView>
                    ...
                    <View style={{ padding: 20 }}>
                        ...
                        <View style={{ flexDirection: 'row' }}>
                            <View style={{ width: '50%', alignItems: 'flex-start', justifyContent: 'center' }}>
                                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal }}>Payment collected mode</Text>
                            </View>
                            <View style={{ width: '50%', alignItems: 'flex-end', justifyContent: 'center' }}>
                                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_s, fontFamily: normal }}>{data.payment_mode}</Text>
                            </View>
                        </View>
                        <View>
                        <View style={{ margin: 5 }} />
                        <View style={{ flexDirection: 'row' }}>
                            <View style={{ width: '50%', alignItems: 'flex-start', justifyContent: 'center' }}>
                                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal }}>Driver Earnings</Text>
                            </View>
                            <View style={{ width: '50%', alignItems: 'flex-end', justifyContent: 'center' }}>
                                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_s, fontFamily: normal }}>{global.currency}{data.driver_commission}</Text>
                            </View>
                        </View>
                        <View style={{ margin: 5 }} />
                        <View style={{ flexDirection: 'row' }}>
                            <View style={{ width: '50%', alignItems: 'flex-start', justifyContent: 'center' }}>
                                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal }}>Admin Comission</Text>
                            </View>
                            <View style={{ width: '50%', alignItems: 'flex-end', justifyContent: 'center' }}>
                                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_s, fontFamily: normal }}>{global.currency}{data.admin_commission}</Text>
                            </View>
                        </View>
                        </View>
            ...
            {data.customer_rating == 0 && from != 'trips' &&
                <View style={{ position: 'absolute', bottom: 10, width: '100%', height: 100, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
            ...
            {data.customer_rating == 0 && from == 'trips' &&
                <View style={{ position: 'absolute', bottom: 10, width: '90%', height: 100, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', alignSelf:"center" }}>
