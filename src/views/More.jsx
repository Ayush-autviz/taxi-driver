    ...
    <SafeAreaView style={{ backgroundColor: colors.theme_bg_three, flex: 1 }}>
      ...
      <ScrollView>
        <Dialog.Container visible={dialog_visible} contentStyle={{ backgroundColor: colors.theme_bg_three }}>
          <Dialog.Title style={{color:colors.theme_bg_two}}>Confirm</Dialog.Title>
          <Dialog.Description style={{color:colors.theme_bg_two}}>
            Do you want to logout?
          </Dialog.Description>
          <Dialog.Button style={{color:colors.theme_bg}} label="Yes" onPress={handleLogout} />
          <Dialog.Button style={{color:colors.theme_bg}} label="No" onPress={handleCancel} />
        </Dialog.Container>
