...
const Earnings = (props) => {
  ...
  const [monthly_earning, setMonthlyEarning] = useState(0); 
  ...
  const call_get_earnings = (date) => {
    ...
    .then(async response => {
        ...
        setMonthlyEarning(response.data.result.month_earnings)
        setWeeklyEarning(response.data.result.week_earnings)
        setLoading(false);
    })
    .catch(error => {
        setLoading(false);
        ...
        <View activeOpacity={1} style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
          ...
          <DropShadow
            ...
            >
              ...
              <View style={{ backgroundColor:colors.theme_bg_three, width:'49%', padding:20, alignItems:'center', justifyContent:'center', borderRadius:10}}>
                <Text numberOfLines={1} style={{ color: colors.text_grey, fontSize: f_s, fontFamily:normal }}>Weekly Earnings</Text>
                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_xl, fontFamily:bold, margin:10 }}>{global.currency}{weekly_earning}</Text>
              </View>
              <View style={{ margin:5 }}/>
              <View style={{ backgroundColor:colors.theme_bg_three, width:'49%', padding:20, alignItems:'center', justifyContent:'center', borderRadius:10}}>
                <Text numberOfLines={1} style={{ color: colors.text_grey, fontSize: f_s, fontFamily:normal }}>Monthly Earnings</Text>
                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_xl, fontFamily:bold, margin:10 }}>{global.currency}{monthly_earning}</Text>
              </View>
              </View>
              <View style={{ margin:5 }}/>
