        ...
        axios({
            ...
            .then(async response => {
                ...
                dropDownAlertRef({
                    ...
                    message:'Your aadhar number has been updated',
                  });
                go_back();
            })
            .catch(error => {
    ...
    return (
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_xl, fontFamily: bold }}>Enter your account number</Text>
                <View style={{ margin: 5 }} />
                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal }}>You need enter your account number</Text>
                <View style={{ margin: 20 }} />
                <View style={{ width: '80%' }}>
