      ...
      .then(async response => {
        ...
        if (response.data.status == 1) {
          ...
          dropDownAlertRef({
            ...
            message:'Sorry customer cancelled',
          });
          await go_back();
        }
      })
              ...
              {on_load == 1 ?
                <View>
                 ...
                 <Dialog.Container
                  ...
                  >
                    <Dialog.Title>Your New Booking</Dialog.Title>
                    <Dialog.Description>
                      <View>
                        <View style={{ padding: 10 }}>
                    ...
                    <Dialog.Button footerStyle={{ fontSize: f_m, color: colors.theme_fg_two, fontFamily: regular }} label="Accept" onPress={call_trip_accept} />
                    <Dialog.Button footerStyle={{ fontSize: f_m, color: colors.theme_fg_two, fontFamily: regular }} label="Reject" onPress={call_trip_reject} />
                    </Dialog.Container>
                </View>
                :
