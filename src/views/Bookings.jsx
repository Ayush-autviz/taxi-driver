...
const Bookings = (props) => {
    ...
    const navigate = (trip_id, status) => {
        if (filter == 1 && status == 5) {
            ...
            navigation.navigate('Bill', { trip_id: trip_id, from: 'trips' })
            //dropDownAlertRef.alertWithType('error', 'Error', 'This trip is' + ' ' + status_name);
        }
    }
        ...
        ({ item, viewableItems }) => {
            ...
            return (
                <Animated.View style={[
                    ...
                    <TouchableOpacity activeOpacity={1} onPress={navigate.bind(this, item.id, item.status)} style={{ alignItems: 'center', borderRadius: 10, padding: 10 }}>
                        <DropShadow
                            style={{
                                width: '95%',
                                marginBottom: 5,
                ...
                >
                    <View style={{ flexDirection: 'row', backgroundColor: colors.theme_bg_three, borderRadius: 10 }}>
                        ...
                        <TouchableOpacity onPress={change_filter.bind(this, 2)} style={[filter == 2 ? styles.segment_active_bg : styles.segment_inactive_bg]}>
                            <Text style={[filter == 2 ? styles.segment_active_fg : styles.segment_inactive_fg]}>Upcoming</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={change_filter.bind(this, 3)} style={[filter == 3 ? styles.segment_active_bg : styles.segment_inactive_bg]}>
                            <Text style={[filter == 3 ? styles.segment_active_fg : styles.segment_inactive_fg]}>Completed</Text>
                        </TouchableOpacity>
                    </View>
                </DropShadow>
            </View>
