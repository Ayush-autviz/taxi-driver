      ...
      {upload_status == 0 ? (
        <ScrollView style={{ padding: 10 }}>
          ...
          <View>
            ...
            <Text
              style={{ fontFamily: normal, color: colors.grey, fontSize: f_xs }}
            >
            ...
            >
              <View style={{ width: "70%" }}>
                <Text
                  style={{
                    fontFamily: bold,
                    color: vehicle_certificate.color,
                    fontSize: f_s,
                  }}
                >
        ...
        >
          ...
          >
            Your documents are uploaded.Please wait admin will verify your
            documents.
          </Text>
