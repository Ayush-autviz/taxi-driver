...
const Wallet = (props) => {
    ...
    const call_ride_history = (trip_id, type) => {
        if (type == 2) {
    ...
    const show_list = ({ item }) => (
        <TouchableOpacity onPress={call_ride_history.bind(this, item.id, item.type)} activeOpacity={1} style={{ flexDirection: 'row', width: '100%', marginTop: 10, marginBottom: 10 }}>
