...
const Dashboard = (props) => {
  ...
  useEffect(() => {
    ...
    setTimeout(function () { //booking_sync() 
    }, 3000)
      ...
      <View style={{ padding: 15, backgroundColor: colors.theme_bg_three, flexDirection: 'row', position: 'absolute', top: 20, width: '90%', marginLeft: '5%', borderRadius: 10 }}>
        <View style={{ width: 50, right:0, top:450, position:'absolute' }}>
          <TouchableOpacity onPress={call_trip_settings.bind(this)}>
            <Icon type={Icons.Ionicons} name="settings" style={{ fontSize: 40, color: colors.theme_bg_two }} />
          </TouchableOpacity>
        </View>
        
        <View style={{ width: '100%', alignItems: 'center', justifyContent: 'center' }}>
          <View style={{ borderRadius:10, padding:5, flexDirection:'row'}}>
            <TouchableOpacity onPress={change_state.bind(this,0)} activeOpacity={1} style={{ width:'20%', borderRadius:5, alignItems:'center', justifyContent:'center'  }}>
              <Icon type={Icons.MaterialCommunityIcons} name="engine-off" style={{ fontSize: 25, color: switch_value == 0 ? colors.theme_fg_two : colors.grey }} />
              <Text style={{ color: switch_value == 0 ? colors.theme_fg_two : colors.grey, fontSize:f_s, fontFamily: bold }}>Offline</Text>
            </TouchableOpacity>
            <View style={{ width:'20%', borderBottomWidth:1, height:10, borderStyle:'dotted', marginTop:15}} />
            <TouchableOpacity onPress={change_state.bind(this,1)} activeOpacity={1}  style={{ width:'20%', borderRadius:5, alignItems:'center', justifyContent:'center'  }}>
              <Icon type={Icons.FontAwesome5} name="car" style={{ fontSize: 25, color: (switch_value == 1 && gtn_status == 0) ? colors.success : colors.grey }} />
              <Text style={{ color: (switch_value == 1 && gtn_status == 0) ? colors.success : colors.grey, fontSize: f_s, fontFamily: bold }}>Online</Text>
            </TouchableOpacity>
            <View style={{ width:'20%', borderBottomWidth:1, height:10, borderStyle:'dotted', marginTop:15}} />
            <TouchableOpacity onPress={change_state.bind(this,2)} activeOpacity={1}  style={{ width:'20%', borderRadius:5, alignItems:'center', justifyContent:'center'  }}>
              <Icon type={Icons.Entypo} name="home" style={{ fontSize: 25, color: gtn_status == 1 ? colors.theme_fg : colors.grey }} />
              <Text style={{ color: gtn_status == 1 ? colors.theme_fg : colors.grey, fontSize: f_s, fontFamily: bold }}>Home</Text>
            </TouchableOpacity>
          </View>
          {/*<Switch
      ...
      <View style={{ padding: 15, backgroundColor: colors.theme_bg, height: 150, position: 'absolute', bottom: 80, width: '90%', marginLeft: '5%', borderRadius: 10 }}>
        ...
        >
          <View style={{ flexDirection: 'row', width: '100%' }}>
            <TouchableOpacity activeOpacity={1} onPress={call_today_rides.bind(this)} style={{ width: '33%', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <TouchableOpacity activeOpacity={1} onPress={call_earnings.bind(this)} style={{ width: '33%', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <View style={{ flexDirection: 'row', width: '100%' }}>
            ...
            <View style={{ width: '33%', alignItems: 'center', justifyContent: 'center' }}>
              <Text style={{ color: colors.theme_fg_three, fontSize: f_tiny, fontFamily: normal }}>Incentive</Text>
            </View>
          </View>
        </DropShadow>
      </View>
      ...
      <View style={{ position: 'absolute', top: 90, width: '100%' }}>
        {pending_hire_bookings > 0 &&
          <TouchableOpacity activeOpacity={1} onPress={navigate_rental.bind(this)} style={{ flexDirection: 'row', backgroundColor: colors.success_background, borderRadius: 10, alignItems: 'center', justifyContent: 'center', padding: 10, width: '90%', marginLeft: '5%', marginBottom: 10 }}>
            ...
            <View style={{ margin: 5 }} />
            <Text style={{ fontFamily: regular, fontSize: f_xs, color: colors.success }}>You have received driver hire request</Text>
          </TouchableOpacity>
        }
        {wallet == 0 &&
