...
import { normal, bold, get_driver_today_bookings, api_url, img_url, loader, no_data_loader, cancel, f_s, f_xs, f_tiny, f_xl } from '../config/Constants';
        ...
        ({ item, viewableItems }) => {
            ...
            return (
                <Animated.View style={[
                    ...
                    <TouchableOpacity onPress={navigate.bind(this, item.id, item.status)} activeOpacity={1} style={{ alignItems: 'center', borderRadius: 10, padding: 10 }}>
                        <DropShadow
                            style={{
                                width: '95%',
                                marginBottom: 5,
        ...
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={{ width: '5%' }} />
                <TouchableOpacity activeOpacity={1} onPress={navigate_home.bind(this)} style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
                    <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_two, fontSize: f_xl, fontFamily: bold }}>Today Rides</Text>
                </TouchableOpacity>
