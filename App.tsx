...
const TabArr = [
  { route: 'Dashboard', label:'Home', type: Icons.FontAwesome, icon: 'car', component: Dashboard, color: colors.theme_fg, alphaClr: colors.theme_bg_three },
  { route: 'Bookings', label:'Bookings', type: Icons.FontAwesome, icon: 'book', component: Bookings, color: colors.theme_fg, alphaClr: colors.theme_bg_three },
  ...
  { route: 'More', label:'More', type: Icons.Ionicons, icon: 'settings', component: More, color: colors.theme_fg, alphaClr: colors.theme_bg_three },
];
